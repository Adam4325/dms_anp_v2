...
class _ListOpenDoNCState extends State<ListOpenDoNC> {
  ...
  Future<void> load({String search = ""}) async {
    ...
    try {
      var urlBase =
          '${GlobalData.baseUrl}api/marketing/do_detail_apv_non_cemindo.jsp?method=list-open-do';
  ...
  void _onAdd() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const FrmOpenDOMP(item: {}),
      ),
    );
  }
  ...
  void _onEdit(Map<String, dynamic> item) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => FrmOpenDOMP(item: item),
      ),
    );
  }
  ...
  Future<void> _cancelData(Map<String, dynamic> item) async {
    ...
    final url = Uri.parse(
        "${GlobalData.baseUrl}api/marketing/create_update_delete_dodetailavp_non_mp.jsp");
