...
class FrmOpenDOMP extends StatefulWidget {
  final Map<String, dynamic> item; // nullable

  const FrmOpenDOMP({Key? key, required this.item}) : super(key: key);

  @override
  State<FrmOpenDOMP> createState() => _FrmOpenDOMPState();
}

class _FrmOpenDOMPState extends State<FrmOpenDOMP>
