...
import 'ViewListDoCemindo.dart';

class ListOpenDOCemindo extends StatefulWidget {
  @override
  _ListOpenDOCemindoState createState() => _ListOpenDOCemindoState();
}

class _ListOpenDOCemindoState extends State<ListOpenDOCemindo> {
  ...
  void _onViewListDo() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>  ViewListDoCemindo(),
      ),
    );
  }
