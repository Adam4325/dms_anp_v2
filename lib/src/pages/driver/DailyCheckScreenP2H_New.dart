...
class DailyCheckScreenP2H_New extends StatefulWidget {
  @override
  _DailyCheckScreenP2H_NewState createState() => _DailyCheckScreenP2H_NewState();
}

class _DailyCheckScreenP2H_NewState extends State<DailyCheckScreenP2H_New> {
              ...
              if (mounted) {
                ...
                Timer(Duration(seconds: 1), () async {
                  ...
                  if (mounted) {
                    Navigator.pushReplacement(
                      globalScaffoldKey.currentContext!,
                      MaterialPageRoute(builder: (context) => ViewAntrianP2H()),
                    );
                  }
                });
              }
                            ...
                            data: Theme.of(context).copyWith(
                              ...
                              radioTheme: RadioThemeData(
                                fillColor: MaterialStateProperty
                                  ...
                                  if (selectedValues[groupId] == 'tidak') {
                                    return Colors.red;
                                  }
                                  return Colors.blue;
                                }),
                      ...
                      ...subs.map((item) => Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(item['subs_inspeksi_name']),
                            ),
                          ],
                        ),
                      )).toList(),
