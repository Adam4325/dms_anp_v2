...
class ListDriverInspeksi extends StatefulWidget {
  @override
  _ListDriverInspeksiState createState() => _ListDriverInspeksiState();
}

class _ListDriverInspeksiState extends State<ListDriverInspeksi> {
                ...
                Expanded(
                  ...
                  onPressed: () async {
                    ...
                    Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                            builder: (context) => FrmInspeksiVehicleP2H()));
                  },
                  style: ButtonStyle(
