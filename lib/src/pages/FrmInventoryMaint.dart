...
class FrmInventoryMaint extends StatefulWidget {
  ...
  @override
  _FrmInventoryMaintState createState() => _FrmInventoryMaintState();
}

//final globalScaffoldKey = GlobalKey<ScaffoldState>();

class _FrmInventoryMaintState extends State<FrmInventoryMaint> {
  ...
  void CreateInventory(String usr) async {
    try {
      ...
      if (itdinvtrannbr == null || itdinvtrannbr == "") {
        alert(globalScaffoldKey.currentContext!, 0, "Number tidak boleh kosong",
            "error");
      } else if (ititemid == null || ititemid == "") {
        alert(globalScaffoldKey.currentContext!, 0, "ItemID tidak boleh kosong",
            "error");
      } else if (uomid == null || uomid == "") {
        alert(globalScaffoldKey.currentContext!, 0, "UOMID tidak boleh kosong",
            "error");
      } else if (idtype == null || idtype == "") {
        alert(globalScaffoldKey.currentContext!, 0, "Type tidak boleh kosong",
            "error");
      }
      ...
      // }
        ...
        alert(globalScaffoldKey.currentContext!, 0,
            "Accessories tidak boleh kosong", "error");
      } else if (part_name == null || part_name == "") {
        alert(globalScaffoldKey.currentContext!, 0,
            "Part name tidak boleh kosong", "error");
      } else if (idqty == null || idqty == "") {
        alert(globalScaffoldKey.currentContext!, 0,
            "Quantity (QTY) tidak boleh kosong", "error");
      } else if (int.parse(idqty) <= 0) {
        alert(globalScaffoldKey.currentContext!, 0,
            "Quantity (QTY) harus lebih dari 0", "error");
      } else {
        EasyLoading.show();
        var encoded = Uri.encodeFull(
            "${BASE_URL}api/inventory/create_inv_detail_maint.jsp");
        print(encoded);
          ...
          if (response.statusCode == 200) {
            ...
            if (status_code == 200) {
              ...
              alert(globalScaffoldKey.currentContext!, 2,
                  "Gagal menyimpan ${message}", "warning");
            }
          } else {
            if (EasyLoading.isShow) {
              EasyLoading.dismiss();
            ...
            alert(globalScaffoldKey.currentContext!, 3,
                "Gagal menyimpan ${response.statusCode}", "info");
          }
        });
      }
    } catch (e) {
      ...
      alert(globalScaffoldKey.currentContext!, 0,
          "Client, Gagal Menyimpan Data", "error");
      print(e.toString());
    }
  }
  ...
  void UpdateInventory(String usr) async {
    try {
      ...
      if (itdinvtrannbr == null || itdinvtrannbr == "") {
        ...
        alert(globalScaffoldKey.currentContext!, 0,
            "Line Number tidak boleh kosong", "error");
      } else if (ititemid == null || ititemid == "") {
        alert(globalScaffoldKey.currentContext!, 0, "ItemID tidak boleh kosong",
            "error");
      } else if (uomid == null || uomid == "") {
  ...
  Widget _buildButtonCreateOrUpdate(BuildContext context) {
    ...
    //                 style: ElevatedButton.styleFrom(
    //                     elevation: 2.0,
    //                     backgroundColor: Colors.grey.shade500, // ✅ Gray for No/Cancel
    //                     shape: RoundedRectangleBorder(
    //                       borderRadius: BorderRadius.circular(8),
    //                     ),
    //                     padding:
