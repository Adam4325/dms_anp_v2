...
class FrmObp extends StatefulWidget {
  const FrmObp({Key? key}) : super(key: key);

  @override
  _FrmObpState createState() => _FrmObpState();
}

class _FrmObpState extends State<FrmObp> {
  String selSangsi = '';
  ...
  Uint8List? _bytesImageSTNK;
  Uint8List? _bytesImageSIM;
  Uint8List? _bytesImageKTP;
