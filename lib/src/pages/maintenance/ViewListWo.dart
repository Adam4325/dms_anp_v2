...
class ViewListWo extends StatefulWidget {
  @override
  _ViewListWoState createState() => _ViewListWoState();
}

class _ViewListWoState extends State<ViewListWo> {
                            ...
                            actions: <Widget>[
                              ...
                              new ElevatedButton.icon(
                                ...
                                onPressed: () async{
                                  ...
                                  prefs.setString("vhcid_mcn",value['vhcid']);
                                  Navigator.pushReplacement(
                                      context, MaterialPageRoute(builder: (context) => FrmWoStart()));
                                },
                                style: ElevatedButton.styleFrom(
                                    elevation: 0.0,
                                    backgroundColor: Colors.blue,
