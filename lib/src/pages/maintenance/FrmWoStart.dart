...
class FrmWoStart extends StatefulWidget {
  @override
  _FrmWoStartState createState() => _FrmWoStartState();
}

class _FrmWoStartState extends State<FrmWoStart> {
  ...
  Future getListMechanicStaff() async {
    ...
    if (dataStaffMCN.length == 0 && dataStaffMCN == []) {
      alert(globalScaffoldKey.currentContext!, 0,
          "Gagal Load data Staff Mechanic", "error");
    }
  }
  ...
  Future getListMechanicForeman() async {
    ...
    if (dataForemanMCN.length == 0 && dataForemanMCN == []) {
      alert(globalScaffoldKey.currentContext!, 0,
          "Gagal Load data Foreman Mechanic", "error");
    }
  }
  ...
  Future<bool> closeAntrian(String vhcid, String loginname) async {
    ...
    try {
      var urlData =
          "${GlobalData.baseUrl}api/maintenance/close_antrian.jsp?method=service&vhcid=" +
              vhcid +
              "&loginname=" +
              loginname;
      var encoded = Uri.encodeFull(urlData);
              ...
              child: Column(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Text("WOD NUMBER : ${wodwonbr}",
                        style: TextStyle(fontSize: 14)),
                  ),
                  Container(
                    margin: EdgeInsets.only(
                        left: 20, top: 10, right: 20, bottom: 0),
                    child: Text("WOD SERVICE NUMBER : ${wodsvcrreqnbr}",
                        style: TextStyle(fontSize: 14)),
                  ),
                  Divider(
                    color: Colors.red,
                  ...
                  Container(
                    margin: EdgeInsets.only(
                        left: 20, top: 10, right: 20, bottom: 0),
                    child: Text("VHCID", style: TextStyle(fontSize: 12)),
                  ),
                  Container(
                    margin:
                  ...
                  Container(
                    margin: EdgeInsets.only(
                        left: 20, top: 10, right: 20, bottom: 0),
                    child: Text("DRIVER", style: TextStyle(fontSize: 12)),
                  ),
                  Container(
                    margin:
                        EdgeInsets.only(left: 20, top: 0, right: 20, bottom: 0),
                          ...
                          onPressed: () {
                            showDialog(
                              ...
                              builder: (context) => new AlertDialog(
                                ...
                                content: new Text("Create Worked Order?"),
                                actions: <Widget>[
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (_wodwonbr == "" ||
                                        ...
                                        alert(
                                            globalScaffoldKey.currentContext!,
                                            0,
                                            "Mechanic ID 1 tidak boleh kosong",
                                            "error");
